			...
			<ul>
				...
				<li class="navBarCommonItem">
					<router-link to="/Creator"><a
							style="color: black; font-weight: bold; border-bottom: #056DE8 solid 5px">创作中心</a></router-link>
				</li>
				<li class="navBarCommonItem">
