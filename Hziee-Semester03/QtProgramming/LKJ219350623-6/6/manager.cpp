...
// 出售商品按钮
void manager::on_sellBtn_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}
// 商品入库按钮
void manager::on_buyBtn_clicked()
{
    ui->stackedWidget->setCurrentIndex(1);
}
// 添加商品按钮
void manager::on_addBtn_clicked()
{
    ui->stackedWidget->setCurrentIndex(2);
}
// 商品查询按钮
void manager::on_queryBtn_clicked()
{
    ui->stackedWidget->setCurrentIndex(3);
}
// 修改密码按钮
void manager::on_passwordBtn_clicked()
{
    ui->stackedWidget->setCurrentIndex(4);
}

// 出售商品的商品类型改变时
void manager::on_sellTypeComboBox_currentIndexChanged(QString type)
{
    if (type == "请选择类型") {
    // 进行其他部件的状态设置
        on_sellCancelBtn_clicked();
...
// 已有商品入库的商品类型改变时
void manager::on_goodsTypeComboBox_currentIndexChanged(QString type)
{
    if (type == "请选择类型") {
    // 进行其他部件的状态设置
        on_goodsCancelBtn_clicked();
...
// 新商品入库类型改变时
void manager::on_newTypeComboBox_currentIndexChanged(QString type)
{
    if (type == "请选择类型") {
    // 进行其他部件的状态设置
        on_newCancelBtn_clicked();
...
// 查询商品类型改变时
void manager::on_queryTypeComboBox_currentIndexChanged(QString type)
{
    if (type == "请选择类型") {
        ui->queryBrandComboBox->setEnabled(false);
    } else {
...
// 出售商品的品牌改变时
void manager::on_sellBrandComboBox_currentIndexChanged(const QString &brand)
{
...
// 已有商品入库的品牌改变时
void manager::on_goodsBrandComboBox_currentIndexChanged(const QString &brand)
{
...
// 新商品品牌改变时
void manager::on_newBrandLineEdit_textChanged(const QString &str)
{
    if (str == "") {
...
//    出售商品数量改变时
void manager::on_sellNumSpinBox_valueChanged(int arg1)
{
    if (arg1 == 0) {
        ui->sellSumLineEdit->clear();
        ui->sellSumLineEdit->setEnabled(false);
...
void manager::on_goodsNumSpinBox_valueChanged(int arg1)
{
    if (arg1 == 0) {
        ui->goodsSumLineEdit->clear();
        ui->goodsSumLineEdit->setEnabled(false);
        ...
        qreal sum = arg1 * ui->goodsPriceLineEdit->text().toInt();
...
void manager::on_newNumSpinBox_valueChanged(int arg1)
{
    qreal sum = arg1 * ui->newPriceSpinBox->value();
    ui->newSumLineEdit->setText(QString::number(sum));
    ui->newOkBtn->setEnabled(true);
}

void manager::on_newPriceSpinBox_valueChanged(int arg1)
{
    qreal sum = arg1 * ui->newNumSpinBox->value();
    ui->newSumLineEdit->setText(QString::number(sum));
    ui->newOkBtn->setEnabled(true);
}

void manager::on_sellOkBtn_clicked()
{
...
void manager::on_goodsOkBtn_clicked()
{
...
void manager::on_newOkBtn_clicked()
{
...
void manager::on_sellCancelBtn_clicked()
{
...
void manager::on_goodsCancelBtn_clicked()
{
...
void manager::on_newCancelBtn_clicked()
{
...
void manager::on_queryPushButton_clicked()
{
...
void manager::on_queryPushButton_2_clicked()
{
